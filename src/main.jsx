...
function App() {
  ...
  useEffect(() => {
    if (window.localStorage.getItem('zheshan-map-guide-seen') !== '1') setGuideOpen(true)
  }, [])
  useEffect(() => {
